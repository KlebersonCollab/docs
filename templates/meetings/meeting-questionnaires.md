# Questionários por Reunião - Ciclo de Vida do Software
...
#### 1.2. Questionário - Reunião de Definição de Requisitos (PRD)
...
##### Perguntas sobre Componentes (Nível 3)
...
#### 3.1. Questionário - Reunião de User Stories (Sprint Planning)
