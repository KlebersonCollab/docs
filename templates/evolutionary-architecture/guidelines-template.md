...
**Related Documents**:
- [Evolutionary Architecture Guide](../../architecture/evolutionary-architecture/README.md)
- [Metrics Definition](../../architecture/evolutionary-architecture/metrics-definition.md)
- [Automation Strategies](../../architecture/evolutionary-architecture/automation-strategies.md)

**Versão em Português**: [Template de Diretrizes Arquiteturais (PT-BR)](./pt-br/guidelines-template.md)
